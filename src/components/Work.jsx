...
const projects = [
  {
    ...
    desc: 'A space-themed arcade gaming platform with 13 provably-fair games including Rocket Crash, Cosmic Plinko, Blackjack and Keno, plus player wallets, an agent and clubs economy, weekly leaderboards and a real-time admin dashboard tracking 376+ users and $275k+ in volume.',
  ...
  },
  {
    ...
    desc: 'A premium platform for professional tutors: a cinematic public brand site, a secure dashboard for student management and review moderation, and live, code-protected progress reports parents open from a private link. No accounts needed, always current, print-to-PDF ready.',
    points: ['Live parent reports with access codes & view tracking', 'Exam trends & subject progress charts', 'Built-in CMS so the tutor edits the site live'],
